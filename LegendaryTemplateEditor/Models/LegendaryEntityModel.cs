...
namespace LegendaryTemplateEditor.Models
{
    ...
    public partial class CustomSetsModel
    {
        ...
        {
            return JsonConvert.DeserializeObject<CustomSetsModel>(json, LegendaryTemplateEditor.Models.Converter.Settings);
        }
    }
    ...
    public static class Serialize
    {
        ...
        {
            return JsonConvert.SerializeObject(self, LegendaryTemplateEditor.Models.Converter.Settings);
        }
    }
