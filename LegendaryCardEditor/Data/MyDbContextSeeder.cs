    ...
    public static class MyDbContextSeeder
    {
        public static void Seed(DataContext context)
        {
            ...
            context.EntityTemplates.Add(new Templates()
            {
                ...
                FormShowAttributes = true,
                FormShowAttributesAttack = true,
                FormShowAttributesCost = true,
                FormShowAttributesPiercing = true,
                FormShowAttributesRecruit = true,
                FormShowPowerPrimary = true,
                FormShowPowerSecondary = true,
                FormShowTeam = true,
            ...
            context.EntityCards.Add(new Cards()
            {
                ...
                CardTemplate = context.EntityTemplates.Local.Single(x => x.TemplateName == "hero_rare"),
                CardText = "You may gain a Wound. If you do get <k>+2<ATTACK>.",
                CardTextFont = 22,
                CardType = context.EntityCardTypes.Local.Single(x => x.CardTypeName == "hero_rare"),
                ExportedCardFile = "angela_hero_rare_2221013.png",
            ...
            context.EntityCards.Add(new Cards()
            {
                ...
                ExportedCardFile = "angela_hero_common_2221010.png",
